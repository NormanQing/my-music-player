...
export default {
  ...
  methods: {
      ...
      this.music = [
        {
          ...
          'comment': 0,
          'share': 100,
          'coverImgUrl': '../static/musiclist/1.jpg',
          'creator': {'nickname': 'ccc'},
          'musiclist': [
            {
              'name': '11-11',
              'user': 'user-1',
        ...
        },
        {
          ...
          'share': 100,
          'creator': {'nickname': 'ccc'},
          'coverImgUrl': '../static/musiclist/2.jpg',
          'musiclist': [
            {
              'name': '22',
              'user': 'user-2',
    ...
    _initScroll () {
      if (!this.helloSroll) {
        this.helloSroll = new BScroll(this.$refs.helloWrapper, {click: true})
      } else {
        this.helloSroll.refresh()
      }
    },
    openmenuTotal (item) {
